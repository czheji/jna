...
Java_com_zcsmart_jna_PerformanceTest_00024JNILibrary_cos(JNIEnv *UNUSED(env), jclass UNUSED(cls), jdouble x) {
  return cos(x);
}

JNIEXPORT jint JNICALL
Java_com_zcsmart_jna_PerformanceTest_00024JNILibrary_getpid(JNIEnv *UNUSED(env), jclass UNUSED(cls)) {
#ifdef _WIN32
  extern int _getpid();
  return _getpid();
#else
